<html>
    ...
    <head>
        <title> Mega Cat Studios - Main Menu </title>
    </head>
    ...
    <body>
        ...
        <div class ="main-container">
            ...
            <div class = "grid-container">
                ...
                <div class ="grid-item">
                    <button class= "small_btn" type="button" id="btn" onClick="window.location.href='platforms.php'"> Platforms </button>
                </div>

                <div class ="grid-item">
                    <button class= "small_btn" type="button" id="btn" onClick="window.location.href='publishers.php'"> Publishers </button>
                </div>

                <div class ="grid-item">
                    <button class= "small_btn" type="button" id="btn" onClick="window.location.href='positions.php'"> Positions </button>
                </div>
